...
class ViewController: UIViewController {
	...
	@IBOutlet weak var speedWriter: UITextField!
	@IBOutlet weak var toggleManualButton: UIButton!
	...
	@IBAction func toggleAnimation(sender: AnyObject) {
		if(bunnyView1.isAnimating()) {
			...
			toggleButton.setTitle("Stop It!", forState: UIControlState.Normal)
		}
	}
	
	@IBAction func setManualSpeed(sender: AnyObject) {
	/*	bunnyView1.animationDuration = Double(speedWriter.text)
		bunnyView2.animationDuration = bunnyView1.animationDuration + Double(arc4random_uniform(11))
		bunnyView3.animationDuration = bunnyView1.animationDuration + Double(arc4random_uniform(11))
		bunnyView4.animationDuration = bunnyView1.animationDuration + Double(arc4random_uniform(11))
		bunnyView5.animationDuration = bunnyView1.animationDuration + Double(arc4random_uniform(11))
		bunnyView1.startAnimating()
		bunnyView2.startAnimating()
		bunnyView3.startAnimating()
		bunnyView4.startAnimating()
		bunnyView5.startAnimating()
		toggleButton.setTitle("Stop It!", forState: UIControlState.Normal)
		let hopRateString = String(format:"%1.2f hps", (Int(self.speedWriter.text!)!)) //help!!
		hopsPerSecond.text = hopRateString
		speedSlider.value = Float(speedWriter.text!)!
		speedWriter.placeholder = String(speedSlider.value) */
		speedSlider.value = Float((speedWriter.text as NSString?)!.floatValue)
		setSpeed(nil)
	}
	
	@IBAction func setSpeed(sender: AnyObject?) {
		bunnyView1.animationDuration = Double(1/speedSlider.value)
		bunnyView2.animationDuration = bunnyView1.animationDuration + Double(arc4random_uniform(5))
		bunnyView3.animationDuration = bunnyView1.animationDuration + Double(arc4random_uniform(5))
		bunnyView4.animationDuration = bunnyView1.animationDuration + Double(arc4random_uniform(5))
		bunnyView5.animationDuration = bunnyView1.animationDuration + Double(arc4random_uniform(5))
		bunnyView1.startAnimating()
		bunnyView2.startAnimating()
		bunnyView3.startAnimating()
		bunnyView4.startAnimating()
		bunnyView5.startAnimating()
		toggleButton.setTitle("Stop It!", forState: UIControlState.Normal)
		let hopRateString = String(format:"%1.2f hps", self.speedSlider.value)
		hopsPerSecond.text = hopRateString
		speedWriter.placeholder = String(speedSlider.value)
	}
